...
<template>
  <section
    v-if="fm?.features"
    ref="sectionRef"
    class="nova-section nova-features nova-home-below-hero"
    p="b-120px"
    :class="{ 'nova-home-below-hero--in-view': isRevealed }"
    style="--nova-home-section-i: 1"
  >
    <div class="nova-home-container">
      ...
      <div class="features-grid-wrap nova-home-below-hero__block">
        <ul class="features-grid">
          <li v-for="(card, i) in fm.features?.cards" :key="i" class="feature-item">
            <div class="feature-item-inner">
              <div class="feature-card-wrapper nova-home-card-conic-shell" style="--nova-home-card-br: 22px">
                <div class="feature-card nova-home-card-hover nova-home-card-surface">
