...
<template>
  <footer class="nova-footer">
    <div class="nova-home-container footer-content">
      ...
      <div class="footer-bottom">
        <span class="copyright footer-copyright">
          ...
          {{ year }}
          <a class="nova-text" target="_blank" :href="siteConfig.author.link">
        ...
        <span v-if="themeConfig.footer.powered" class="powered">
          Powered by
          <span>
            <a class="nova-text" :href="pkg.repository.url" target="_blank" rel="noopener"> valaxy </a> v{{ pkg.version }}
          </span> | Theme
          <span>
            <a class="nova-text" :href="themeConfig.pkg.homepage" target="_blank" rel="noopener"> {{ config.theme }}</a> v{{ themeConfig.pkg.version }}
          </span>
        </span>
...
.nova-footer {
  position: relative;
  background-color: var(--nova-c-footer-bg);
  ...
  html:not(.dark) & {
    box-shadow:
      0 -1px 0 hsla(var(--nova-c-card-bg-h), var(--nova-c-card-bg-s), var(--nova-c-card-bg-l), 0.06),
  ...
  .footer-bottom {
    ...
    flex-wrap: wrap;
    gap: 1rem;
    border-top: 1px solid var(--nova-c-footer-border);
    padding-top: 1rem;
    font-size: 12px;
    line-height: 1.33337;
    font-weight: 400;
