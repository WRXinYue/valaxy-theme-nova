...
import OceanusHeroParticles from './OceanusHeroParticles.vue'
import OceanusHeroPrismCanvas from './OceanusHeroPrismCanvas.vue'
...
<template>
  <div class="oceanus-hero" :class="heroClass" :style="heroBgStyle">
    <div v-if="showLightStripes" class="oceanus-hero-stripes" aria-hidden="true">
      <div class="oceanus-hero-stripes__bg" />
    </div>

    <template v-if="showPrismDark">
      <div class="oceanus-hero-ambient" aria-hidden="true">
        <div class="oceanus-hero-spotlight">
          <div />
          <div />
          <div />
        </div>
        <div class="oceanus-hero-accent-lines">
          <div>
            <div />
            <div />
            <div />
      ...
      <div class="oceanus-hero-prism-wrap">
        <ClientOnly>
          <OceanusHeroPrismCanvas />
        </ClientOnly>
      </div>
      <ClientOnly>
        <OceanusHeroParticles />
      </ClientOnly>
    </template>
...
.oceanus-hero {
  ...
  .oceanus-hero-stripes__bg {
    ...
    height: 100%;
    min-height: 100%;
    --oceanus-stripes: repeating-linear-gradient(
      100deg,
      var(--stripe-color) 0%,
      var(--stripe-color) 7%,
      transparent 10%,
    ...
    --oceanus-rainbow: repeating-linear-gradient(
      100deg,
      #60a5fa 10%,
      #e879f9 15%,
      #60a5fa 20%,
    ...
    background-image: var(--oceanus-stripes), var(--oceanus-rainbow);
  ...
  .oceanus-hero-stripes__bg::after {
    content: '';
    position: absolute;
    inset: 0;
    background-image: var(--oceanus-stripes), var(--oceanus-rainbow);
    background-size: 200%, 100%;
    animation: oceanus-smooth-bg 60s linear infinite;
    background-attachment: fixed;
  ...
  .oceanus-hero-spotlight {
    ...
    > div {
      ...
      z-index: -1;
      animation:
        oceanus-hero-load 2s ease-in-out forwards,
        oceanus-hero-loadrot 2s ease-in-out forwards,
        oceanus-hero-spotlight 21s ease-in-out infinite reverse;
    }
    ...
    > div:nth-child(1) {
      ...
      animation:
        oceanus-hero-load 2s ease-in-out forwards,
        oceanus-hero-loadrot 2s ease-in-out forwards,
        oceanus-hero-spotlight 17s ease-in-out infinite;
    }
    ...
    > div:nth-child(2) {
      ...
      animation:
        oceanus-hero-load 2s ease-in-out forwards,
        oceanus-hero-loadrot 2s ease-in-out forwards,
        oceanus-hero-spotlight 14s ease-in-out infinite;
    }
  }

  .oceanus-hero-accent-lines {
    --oceanus-accent-line: hsla(210, 75%, 82%, 0.18);
    position: absolute;
    top: 0;
    left: 0;
    right: 0;
    ...
    > div:nth-child(1) > div {
      ...
      width: 100%;
      height: 1px;
      background: linear-gradient(90deg, transparent, var(--oceanus-accent-line), transparent);
      opacity: 0;
      scale: 0;
      animation: oceanus-hero-accentload 2s ease-out 0.4s forwards;
    }
    ...
    > div:nth-child(2) > div {
      ...
      width: 1px;
      height: 100%;
      background: var(--oceanus-accent-line);
      opacity: 0;
      scale: 0;
      animation: oceanus-hero-accentload 2s ease-out 0.2s forwards;
    }
  ...
  &.has-prism .hero-title--main {
    ...
    background:
      radial-gradient(
        2em 2em at 50% 50%,
        transparent calc(var(--oceanus-hero-p) - 2em),
        hsla(0, 0%, 100%, 1) calc(var(--oceanus-hero-p) - 1em),
        hsla(0, 0%, 100%, 1) calc(var(--oceanus-hero-p) - 0.4em),
        transparent calc(var(--oceanus-hero-p))
      ),
    ...
    animation: oceanus-hero-pulse 10s linear 1.2s infinite;
  }
  ...
  &.has-prism .hero-title--echo {
    ...
    background:
      radial-gradient(
        2em 2em at 50% 50%,
        transparent calc(var(--oceanus-hero-p) - 2em),
        transparent calc(var(--oceanus-hero-p) - 1em),
        hsla(0, 0%, 100%, 1) calc(var(--oceanus-hero-p) - 1em),
        hsla(0, 0%, 100%, 1) calc(var(--oceanus-hero-p) - 0.4em),
        transparent calc(var(--oceanus-hero-p) - 0.4em),
        transparent calc(var(--oceanus-hero-p))
      );
    background-clip: text;
    -webkit-background-clip: text;
  ...
  @keyframes oceanus-hero-loadrot {
    0% {
      rotate: 0deg;
      scale: 0;
    }
  ...
  @keyframes oceanus-hero-spotlight {
    0% {
  ...
  @keyframes oceanus-hero-accentload {
    0% {
      opacity: 0;
      scale: 0;
    }
