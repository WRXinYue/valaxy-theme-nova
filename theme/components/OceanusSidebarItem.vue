...
<template>
  ...
  <ul v-if="item.items" v-show="!collapsed" class="oceanus-sidebar-section">
    <li v-for="sidebarItem in item.items" :key="sidebarItem.text" class="oceanus-sidebar-item">
      <RouterLink v-if="sidebarItem.text" :to="sidebarItem.link || ''" class="oceanus-sidebar-item-link inline-flex items-center" active-class="active">
